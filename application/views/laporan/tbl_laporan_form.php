...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Durasi <?php echo form_error('durasi') ?></td><td><input type="text" class="form-control" name="durasi" id="durasi" placeholder="Durasi" value="<?php echo $durasi; ?>" /></td></tr>
